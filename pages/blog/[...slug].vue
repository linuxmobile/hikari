...
<template>
  <Main>
    <section class="flex items-center justify-start p-20 gap-x-8 border-b-1 border-gray-800">
    ...
    <ContentRenderer v-if="page" :value="page" class="px-20 py-10 text-sm prose-sm flex flex-col gap-y-4" />
    </ Main>
</template>
<style scoped>
/* HEADERS */
